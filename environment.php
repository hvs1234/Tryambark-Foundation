...
<head>
  ...
  <title>Environment - Tryambak Foundation</title>
...
<section class="breadcrumbs-page-wrap">
  <div class="bg-fixed pos-rel breadcrumbs-page" style="background-image:url('images/home-banner-three.jpg');">
    <div class="container">
      <h1>Environment</h1>
  ...
  <section class="wide-tb-100">
    <div class="container">
      <h1 class="heading-main">
        ...
        Uttarakhand's Natural Heritage Preservation
      </h1>
      <div class="content">
        <p>
        ...
        <h3 class="text-brown">Bugyal Conservation:</h3>
        <div class=" mt-4 mb-4">
