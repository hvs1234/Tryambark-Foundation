	...
	<div class="top-bar-right d-flex align-items-center text-md-left">
		<div class="container">
			<div class="row-align-items-center mt-2 mb-3">
				<marquee direction="left" scrollamount="20" style="font-size: 1.3rem;">Our Foundation is Income Tax
					Exempt under 80G, 12A and CSR Certified</marquee>
			</div>
			<div class="row align-items-center">
					...
					<ul>
						...
						<li>
							<i data-feather="mail"></i> <a
								href="mailto:info@tryambakfoundation.org"><span>info@tryambakfoundation.org</span></a>
						</li>
						<!-- <li>
				...
				<div class="col-md-2">
					<div class="social-icons text-right">
						<a href="https://www.facebook.com/tryambakfoundation" target="_blank"><i
								class="icofont-facebook"></i></a>
						<a href="https://instagram.com/tryambakfoundation?igshid=OGQ5ZDc2ODk2ZA==" target="_blank"><i
								class="icofont-instagram"></i></a>
						<a href="https://youtube.com/@tryambakfoundation?si=M_4jU8mYCIvHdF0f" target="_blank"><i
	...
	<nav class="navbar navbar-expand-lg header-fullpage">
		<div class="container text-nowrap">
			...
			<div class="d-inline-flex request-btn order-lg-last col-auto p-0 align-items-center">
				<a class="nav-link btn btn-default ml-3 donate-btn" href="join.php"><i class="icofont-plus"></i> Join
					Us</a>
			...
			<div class="collapse navbar-collapse" id="navbarCollapse">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item dropdown">
						<a class="nav-link dropdown-toggle-mob" href="javascript:;" data-toggle="dropdown"
